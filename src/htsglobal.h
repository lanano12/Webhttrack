...
/* Use install path from build; avoid macro name PREFIX which conflicts with Windows headers */
#ifdef HTS_INSTALL_PREFIX
#define HTS_PREFIX HTS_INSTALL_PREFIX
#endif
#ifdef HTS_INSTALL_SYSCONFDIR
#define HTS_SYSCONFDIR HTS_INSTALL_SYSCONFDIR
#endif
#ifdef HTS_INSTALL_DATADIR
#define HTS_DATADIR HTS_INSTALL_DATADIR
#endif
#ifdef HTS_INSTALL_LIBDIR
#define HTS_LIBDIR HTS_INSTALL_LIBDIR
#endif
#ifndef HTS_PREFIX
...
#ifdef HTS_INSTALL_DATADIR
#define HTS_HTTRACKDIR HTS_INSTALL_DATADIR"/httrack/"
#elif defined(HTS_DATADIR)
#define HTS_HTTRACKDIR HTS_DATADIR"/httrack/"
#else
