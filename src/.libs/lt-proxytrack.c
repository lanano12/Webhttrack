...
/* ./.libs/lt-proxytrack.c - temporary wrapper executable for .libs/proxytrack.exe
   Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-7~deb12u1

   The proxytrack program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "proxytrack.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.7 Debian-2.4.7-7~deb12u1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# proxytrack - temporary wrapper script for .libs/proxytrack.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7 Debian-2.4.7-7~deb12u1\n", f);
  fputs ("#\n", f);
  fputs ("# The proxytrack program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"proxytrack.exe:proxytrack:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("7 Debian-2.4.7-7~deb12u1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"proxytrack.exe:proxytrack:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"proxytrack.exe:proxytrack:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
